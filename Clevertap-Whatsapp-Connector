...
- **AWS Internal Business Account ID** (e.g., `waba-358f9bdf09124e1b217b79d02f4b69c5`)
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:social-messaging:<region:ap-south-1>:<aws_account_id:545823377798>:phone-number-id/<aws_phone_id:9d391fe12486414db5de0919ee0ff182>"
        },
        {
...
> Replace `<region>`, `<aws_account_id>`, `<aws_phone_id>` and `<bucket_name>`.
